...
{{
  ...
  "scenarios": [
    {{
      ...
      "learning_tip": "one sentence explaining why this test matters for beginners"
    }}
  ],
  "coverage_goals": {{
    "line": 0.85,
  ...
  "education_notes": {{
    "module_summary": "one paragraph explaining what this module does in plain language",
    "key_signals": "which signals are most important to verify and why",
    "common_bugs": "what bugs are most likely in this type of module"
  }}
}}
```
...
def _parse_test_plan_response(raw_text: str) -> TestPlan | None:
    ...
    return TestPlan(
        ...
        education_notes=data.get("education_notes", {}),
    )

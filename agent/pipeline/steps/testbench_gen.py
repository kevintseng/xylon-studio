...
3. Uses cout assertions to print "PASS" or "FAIL"
...
8. Includes `#include "verilated_cov.h"` and calls `VerilatedCov::write("coverage.dat")` before return
...
Use dut->eval() to step the simulation (standard Verilator C++ API).
